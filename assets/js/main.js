...
fetch(json_data)
  ...
  .then(data => {
    ...
    data.results.forEach(film => {
      ...
      if (film.overview !== "" && film.poster_path !== "") {
        ...
        imageElement.addEventListener('load', () => {
          ...
          // Appliquer les couleurs aux éléments de la carte
          // Fond de la carte
          ...
          // Titre du film
          // titleElement.style.color = `rgb(${palette[0][0]}, ${palette[0][1]}, ${palette[0][2]})`; 
          titleElement.style.color = `rgb(255, 255, 255)`; 
          // Description du film
          // texteElement.style.color = `rgb(${palette[0][0]}, ${palette[0][1]}, ${palette[0][2]})`; 
          texteElement.style.color = `rgb(255, 255, 255)`; 
        });
